...
class SNP {
 ...
 public:
  ...
  double max_abf;
  double incl_prob;
  double incl_prob_rb; //rao-blackwellized inclusion probability
  int max_config;
...
class controller {
 ...
 private:
  ...
  vector<map<pair<int, int>, double> > r2_table;
 ...
 public:
  ...
  void set_meta_option(int meta_option){
    meta = meta_option;
  }
 ...
 private:
  ...
  double compute_r2(int i1, int i2, int t);
